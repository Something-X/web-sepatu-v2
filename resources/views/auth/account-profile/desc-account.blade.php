...
<div class="items-center justify-center flex mt-[100px]">
  <div class="group before:hover:scale-95 before:hover:h-[750px] before:hover:bg-white before:hover:border-solid before:hover:border-2 before:hover:border-gray-700 before:hover:w-[500px] before:hover:rounded-b-2xl before:transition-all before:duration-500 before:content-[''] before:w-[500px] before:h-28 before:rounded-2xl before:bg-green-700 before:absolute before:top-0 w-[500px] h-72 relative bg-white flex flex-col items-center justify-center gap-2 text-center rounded-2xl">
...
<div class="-mb-[450px]">
  <div class="relative w-80 mb-3">
      ...
      <input type="text" value="{{ $user->name }}" placeholder="Masukkan Username Anda" name="name" class="transition-all duration-300 block w-full border-gray-800 rounded-lg text-sm focus:border-[#1E293B] focus:ring-[#1E293B] disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
  </div>
  <div class="relative w-80 mb-3 mt-5">
      <label class="block uppercase text-left text-blueGray-600 text-xs font-bold mb-2">
          Email
      </label>
      <input type="email" value="{{ $user->email }}" placeholder="Masukkan Email Anda" name="email" class="transition-all duration-300 block w-full border-gray-800 rounded-lg text-sm focus:border-[#1E293B] focus:ring-[#1E293B] disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
  </div>
  <div class="relative w-80 mb-3 mt-5">
    <label class="block uppercase text-left text-blueGray-600 text-xs font-bold mb-2">
        Password
