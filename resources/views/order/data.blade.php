...
@section('content-frontend')
        ...
        <div class="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 xl:gap-8 px-4 max-w-full mx-3 lg:mx-10 xl:mx-28 mt-10 mb-10 sm:mt-14 sm:mb-14 md:mt-20 md:mb-20">
            ...
            <div class="relative flex w-full max-w-[26rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
                ...
                <div class="p-3 pt-2 sm:p-6 sm:pb-3 mb-2">
                  ...
                  <button class="block w-full select-none rounded-lg bg-green-800 py-1.5 px-3 sm:py-3.5 sm:px-7 text-center align-middle font-sans text-[0.50rem] sm:text-sm font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" type="button" data-ripple-light="true">Lihat Detail
                  </button>
                  </a>
                  @else
    ...
    @endif
    @if ($shoes->isEmpty())
    <footer class="footer bg-[#212121] w-full mt-[750px] p-5">
      @else
      ...
      <div class="flex justify-between mt-5 xl:mr-12 xl:ml-12"> 
          ...
          <div class="ml-1 sm:ml-4 md:ml-12 lg:ml-20 mb-2 sm:mb-3">
              ...
              <div class="flex mt-2 gap-3">
                  <!-- ig   -->
                 <a href="">
                 <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" class="md:w-[25px] sm:w-[19px] w-[15px] md:h-[25px] sm:h-[19px] h-[15px]" x="0" y="0" viewBox="0 0 409.61 409.61" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g><path d="M307.205 0h-204.8C46.09 0 .005 46.085.005 102.4v204.81c0 56.3 46.085 102.4 102.4 102.4h204.8c56.315 0 102.4-46.1 102.4-102.4V102.4c0-56.315-46.085-102.4-102.4-102.4zm68.265 307.21c0 37.632-30.612 68.265-68.265 68.265h-204.8c-37.637 0-68.265-30.633-68.265-68.265V102.4c0-37.642 30.628-68.265 68.265-68.265h204.8c37.653 0 68.265 30.623 68.265 68.265v204.81z" fill="#ffffff" opacity="1" data-original="#000000"></path><circle cx="315.755" cy="93.865" r="25.6" fill="#ffffff" opacity="1" data-original="#000000" class=""></circle><path d="M204.805 102.4c-56.566 0-102.4 45.839-102.4 102.4 0 56.54 45.834 102.41 102.4 102.41 56.55 0 102.4-45.87 102.4-102.41 0-56.561-45.85-102.4-102.4-102.4zm0 170.675c-37.699 0-68.265-30.566-68.265-68.275s30.566-68.265 68.265-68.265 68.265 30.556 68.265 68.265-30.566 68.275-68.265 68.275z" fill="#ffffff" opacity="1" data-original="#000000" class=""></path></g></svg>
                 </a>
                 <!-- fb  -->
                 <a href="">
